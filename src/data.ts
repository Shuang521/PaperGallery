...
export const mockData: Record<string, any[]> = {
  headers: [
    { id: 1, title: 'Stable Diffusion XL Results', image: 'https://images.unsplash.com/photo-1675271591211-126ad94e495d?auto=format&fit=crop&q=80&w=800&h=400', paper: 'SDXL: Improving Latent Diffusion Models', link: 'https://arxiv.org/abs/2307.01952' },
    { id: 2, title: 'DALL-E 3 Generation', image: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&q=80&w=800&h=400', paper: 'DALL-E 3 System Card', link: 'https://openai.com/dall-e-3' },
  ],
  examples: [
  ...
  pipeline: [
    { id: 1, title: 'Transformer Architecture', image: 'https://images.unsplash.com/photo-1639322537228-f710d846310a?auto=format&fit=crop&q=80&w=800&h=600', description: 'The original encoder-decoder structure from Attention Is All You Need.' },
    { id: 2, title: 'ResNet Residual Block', image: 'https://images.unsplash.com/photo-1509228468518-180dd4864904?auto=format&fit=crop&q=80&w=800&h=600', description: 'Skip connection mechanism in Deep Residual Learning.' },
  ],
  templates: [
